...
export default class PanelWebPartWebPart extends BaseClientSideWebPart<IPanelWebPartWebPartProps> {
  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = "";

  public render(): void {
    const element: React.ReactElement<IPanelWebPartProps> = React.createElement(
      PanelWebPart,
      {
